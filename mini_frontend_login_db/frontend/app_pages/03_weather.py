...
if st.button("날씨 조회"):
    ...
    # 네트워크 요청에서 발생할 수 있는 오류를 처리하기 위해 try를 사용합니다.
    try:
        with st.spinner("날씨 정보를 가져오는 중입니다..."):
            # 선택한 도시의 좌표와 필요한 날씨 항목을 쿼리 매개변수로 보냅니다.
            response = httpx.get(
                WEATHER_URL,
                params={
    ...
    # 예외 종류별로 사용자가 이해할 수 있는 오류 메시지를 표시합니다.
